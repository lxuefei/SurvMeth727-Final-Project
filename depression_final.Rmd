...
yrange_1 <- range(0, yaxis_1)
barplot(yaxis_1, names.arg = xaxis, xlab = "Sentiment Categories", ylab = "Sentiment Score of Group 1", main = "Group 1: Twitter sentiment for 'Depresson'", col = color, border = "white", ylim = yrange, cex.axis = 0.6, cex.names = 0.6)
...
barplot(yaxis_2, names.arg = xaxis, xlab = "Sentiment Categories", ylab = "Sentiment Score of Group 2", main = "Group 2: Twitter sentiment for 'Depresson'", col = color, border = "white", ylim = yrange, cex.axis = 0.6, cex.names = 0.6)
...
barplot(yaxis_3, names.arg = xaxis, xlab = "Sentiment Categories", ylab = "Sentiment Score of Group 3", main = "Group 3: Twitter sentiment for 'Depresson'", col = color, border = "white", ylim = yrange, cex.axis = 0.6, cex.names = 0.6)
